...
namespace collage
{
    ...
    {
        Q_OBJECT
        Q_PROPERTY(collage::Texture* colorAttachment0 READ colorAttachment0 WRITE setColorAttachment0)
        Q_PROPERTY(collage::Texture* colorAttachment1 READ colorAttachment1 WRITE setColorAttachment1)
        Q_PROPERTY(collage::Texture* depthAttachment READ depthAttachment WRITE setDepthAttachment)

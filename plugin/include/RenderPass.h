...
namespace collage
{
    ...
    class RenderPass: public QObject, public RendererElement
    {
        ...
        Q_PROPERTY(collage::Framebuffer* renderToTexture READ renderToTexture WRITE setRenderToTexture)
        Q_PROPERTY(QRect viewport READ viewport WRITE setViewport NOTIFY viewportChanged)
        Q_PROPERTY(bool depthTest READ depthTest WRITE setDepthTest NOTIFY depthTestChanged)
        Q_PROPERTY(collage::DepthFunc::Enum depthFunc READ depthFunc WRITE setDepthFunc NOTIFY depthFuncChanged)
        Q_PROPERTY(collage::CullMode::Enum cullMode READ cullMode WRITE setCullMode NOTIFY cullModeChanged)
        Q_PROPERTY(QQmlListProperty<collage::Entity> entities READ entities)
